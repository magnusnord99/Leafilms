...
- `supabase/migrations/144_harden_tasks_rls.sql` (staff-only RLS på tasks/task_templates/task_assignees — customer JWT kan slette hele produksjonspipelinen inntil den er kjørt)
