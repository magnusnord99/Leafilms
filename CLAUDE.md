...
- `supabase/migrations/146_harden_pricing_rls.sql` (staff-only RLS på price_catalog/discount_factors/contract_templates — customer JWT kan lese/slette priskatalogen, rabatttabellen og kontraktmalene inntil den er kjørt)
