...
export function SectionRenderer({
  ...
  return (
    <section
      key={section.id}
      className={`${section.type === 'concept' ? 'min-h-dvh flex flex-col items-center justify-center px-0' : section.type === 'full_image' ? 'px-0 py-0' : section.type === 'deliverables' ? 'pt-section-lg pb-section px-0 md:px-4' : section.type === 'timeline' ? 'pt-0 pb-0 px-0' : section.type === 'team' ? 'pt-0 pb-section px-2 md:px-4' : 'py-section px-2 md:px-4'} ${section.type === 'cases' || section.type === 'full_image' ? 'bg-transparent' : 'bg-background'} relative`}
    >
