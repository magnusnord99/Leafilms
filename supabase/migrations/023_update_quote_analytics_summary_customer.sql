-- Update quote_analytics_summary view to include customer name
-- This adds customer_name to the view by joining with customers table
-- We need to drop and recreate the view to change column order
